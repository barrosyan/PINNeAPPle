...
def build_loss(
    *,
    ...
    problem_spec:
        ...
        The Arena typically provides a ProblemSpec from pinneapple_environment.
    model_capabilities:
    ...
    supervised_kind:
        'mse' or 'mae'.
    physics_loss_fn:
        Physics loss callable, usually created via pinneapple_pinn.compiler.compile_problem.
