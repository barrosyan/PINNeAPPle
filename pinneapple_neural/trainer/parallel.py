"""Parallelization and GPU optimization utilities for pinneapple training.
...
# ---------------------------------------------------------------------------
# Batched GPU inference helper — canonical impl lives in pinneapple_inference
# ---------------------------------------------------------------------------

from pinneapple_neural.predictor.infer import batched_inference  # noqa: F401  re-export
