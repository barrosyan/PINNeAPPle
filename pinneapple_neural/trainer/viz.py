...
Delegates to ``pinneapple_viz.pinn`` for rich, log-scaled figures.
...
try:
    from pinneapple_tools.visualization.pinn import plot_loss_history as _plot_loss_history, plot_multi_loss
    _VIZ_OK = True
...
def plot_history(
    ...
    *,
    ...
    Delegates to :func:`pinneapple_viz.pinn.plot_loss_history` when available
    ...
    # Minimal fallback (no pinneapple_viz installed)
