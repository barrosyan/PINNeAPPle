...
Each problem exposes:
  ...
  - compiled_losses(**params) -> dict | None   (via pinneaple_physics)
...
class ArenaProblem:
    ...
    def compiled_losses(self, physics_preset_override: Optional[str] = None,
        ...
        if preset_name is None:
            return None
        try:
            from pinneaple_physics import compile_physics, get_preset
    ...
    def to_problem_spec(self, physics_preset_override: Optional[str] = None, **params):
        ...
        if preset_name is None:
            return None
        try:
            from pinneaple_physics import get_preset
...
def register_problem(problem: "ArenaProblem") -> "ArenaProblem":
    ...
    Usage::
        ...
        from pinneaple_arena.problems import register_problem
