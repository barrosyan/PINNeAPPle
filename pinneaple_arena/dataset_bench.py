"""dataset_bench.py -- High-level benchmark API using pinneaple_data datasets.

Every dataset registered in ``pinneaple_data`` has a recommended preset here
...
::
    ...
    from pinneaple_arena.dataset_bench import benchmark_dataset
    ...
    from pinneaple_arena.dataset_bench import list_benchmarks
    list_benchmarks()
...
def benchmark_dataset(
    ...
    **dataset_params,
    ...
    """Run a full Arena benchmark on a pinneaple_data dataset.
    ...
    Parameters
    ----------
    dataset_id   : dataset registered in ``pinneaple_data``
