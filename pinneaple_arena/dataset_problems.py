"""DatasetProblem — ArenaProblem backed by a real pinneaple_data dataset.

Converts any dataset registered in ``pinneaple_data`` into a first-class
...
::
    ...
    from pinneaple_arena.dataset_problems import DatasetProblem
...
# ─────────────────────────────────────────────────────────────────────────────
# Dataset loader (thin wrapper around pinneaple_data)
# ─────────────────────────────────────────────────────────────────────────────
...
def _load_raw(dataset_id: str, **kwargs) -> Dict[str, Any]:
    try:
        ...
        raise ImportError(
            "pinneaple_data is required for DatasetProblem. "
...
class DatasetProblem(ArenaProblem):
    """ArenaProblem backed by a pinneaple_data dataset.
    ...
    def from_dataset(
        ...
        **dataset_params,
        ...
        """Create a DatasetProblem from a pinneaple_data dataset ID.
