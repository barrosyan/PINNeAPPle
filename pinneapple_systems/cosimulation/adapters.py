"""Adapters connecting pinneapple_cosim to PINNeAPPle's model and problem ecosystems.
...
_MODEL_CATALOGUE: Dict[str, Tuple[str, str]] = {
    "vanilla_pinn":  ("pinneapple_models.pinns.vanilla",   "VanillaPINN"),
    "siren":         ("pinneapple_models.siren",            "SIREN"),
    "modified_mlp":  ("pinneapple_models.modified_mlp",     "ModifiedMLP"),
    "hash_grid_mlp": ("pinneapple_models.hash_grid",        "HashGridMLP"),
    "afno":          ("pinneapple_models.afno",             "AFNO"),
    "mgn":           ("pinneapple_models.mesh_graph_net",   "MeshGraphNet"),
}
...
class PINNeProblemNode(CoSimNode):
    ...
    def from_spec(
        ...
        *,
        ...
        Args:
            name:           node name.
            spec:           ``ProblemSpec`` from ``pinneapple_environment``.
        ...
        try:
            ...
            raise ImportError(
                "PINNeProblemNode.from_spec requires pinneapple_pinn."
            ) from exc
