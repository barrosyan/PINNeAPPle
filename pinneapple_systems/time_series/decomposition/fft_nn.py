...
class FFTNNForecaster:
    ...
    Usage::
        from pinneapple_systems.time_series.decomposition import FFTNNForecaster
        from pinneapple_systems.time_series.models import LSTMForecaster, RecurrentConfig
