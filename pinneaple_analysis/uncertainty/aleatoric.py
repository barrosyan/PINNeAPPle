...
Quick start::
    ...
    from pinneaple_analysis.uncertainty import AleatoricHead, aleatoric_nll_loss
...
class AleatoricHead(nn.Module):
    ...
    def predict_with_uncertainty(
        ...
        *,
        ...
        uncertainty, wrap this model with :class:`~pinneaple_uq.mc_dropout.MCDropoutWrapper`
        and call :func:`~pinneaple_uq.decomposition.decompose_uncertainty`.
        """
