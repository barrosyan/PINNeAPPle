...
def uq_predict(
    ...
    **kwargs:
    ...
    if method == "mc_dropout":
        from pinneaple_analysis.uncertainty.mc_dropout import MCDropoutConfig, MCDropoutWrapper
        ...
        from pinneaple_analysis.uncertainty.aleatoric import AleatoricHead
