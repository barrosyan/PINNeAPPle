...
Quick start::
    ...
    from pinneaple_analysis.uncertainty import AleatoricHead, MCDropoutWrapper, MCDropoutConfig
    from pinneaple_analysis.uncertainty import decompose_uncertainty
