...
Quick start
-----------
>>> from pinneaple_analysis.uncertainty import uq_predict, AleatoricHead, decompose_uncertainty
>>> # Aleatoric-only
...
from pinneaple_analysis.uncertainty.core import UQResult, uq_predict
from pinneaple_analysis.uncertainty.mc_dropout import MCDropout, MCDropoutConfig, MCDropoutWrapper
from pinneaple_analysis.uncertainty.ensemble import EnsembleConfig, EnsembleUQ
from pinneaple_analysis.uncertainty.conformal import ConformalPredictor
from pinneaple_analysis.uncertainty.calibration import CalibrationMetrics
from pinneaple_analysis.uncertainty.aleatoric import AleatoricHead, aleatoric_nll_loss
from pinneaple_analysis.uncertainty.decomposition import decompose_uncertainty
from pinneaple_analysis.uncertainty.quantile import QuantileConfig, QuantileHead, QuantileLoss, pinball_loss_torch
