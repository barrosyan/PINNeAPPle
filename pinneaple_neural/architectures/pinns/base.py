...
from pinneaple_neural.architectures.base import BaseModel
...
class PINNBase(BaseModel):
    ...
    def export_torchscript(self, path: str, example_input: Optional[torch.Tensor] = None) -> str:
        ...
        from pinneaple_tools.model_export import export_torchscript as _fn
    ...
    def export_onnx(
        ...
        from pinneaple_tools.model_export import export_onnx as _fn
