"""Pinneaple module capability inventory for tool-based orchestration.

This module treats every Pinneaple sub-package as a *tool* with a declared
...
::
    ...
    Category         | Module(s)
    -----------------+----------------------------------------------------
    simulation       | pinneaple_solvers, pinneaple_dynamics
    pde_solving      | pinneaple_pinn, pinneaple_environment
    symbolic         | pinneaple_symbolic
    data_generation  | pinneaple_data, pinneaple_worldmodel.dataset_factory
    training         | pinneaple_train, pinneaple_worldmodel.trainer
    validation       | pinneaple_validate
    uncertainty      | pinneaple_uq
    inverse          | pinneaple_inverse
    transfer         | pinneaple_transfer
    meta_learning    | pinneaple_meta
    timeseries       | pinneaple_timeseries
    co_simulation    | pinneaple_cosim
    geometry         | pinneaple_geom, pinneaple_worldmodel.geometry
    inference        | pinneaple_inference
    design_opt       | pinneaple_design_opt
    digital_twin     | pinneaple_digital_twin
    visualization    | pinneaple_viz
    world_model      | pinneaple_worldmodel (this package)
...
Usage::
    ...
    from pinneaple_worldmodel.physics_tools import PhysicsToolRegistry
...
class PhysicsTool:
    ...
    module_path : str — dotted path to the underlying Pinneaple module.
...
class PhysicsToolRegistry:
    """Catalogue of all Pinneaple capabilities as callable tools.

    Call :meth:`register_all` to auto-discover tools for all installed
    Pinneaple modules, or use :meth:`register` to add custom tools.
    ...
    def register_all(self) -> None:
        """Auto-discover and register tools for all installed Pinneaple modules."""
    ...
    def _register_simulation_tools(self) -> None:
        """pinneaple_solvers + pinneaple_dynamics"""
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_worldmodel.simulator",
        ...
        # pinneaple_solvers: FDM, FEM, LBM, SPH
        def _run_fdm_solver(pde_kind: str, grid_shape: tuple, **kwargs: Any) -> Any:
            try:
                from pinneaple_simulation.numerical_solvers import SolverRegistry  # type: ignore
        ...
        self.register(PhysicsTool(
            name="run_fdm_solver",
            category="simulation",
            description="Run pinneaple_solvers FDM solver for a given PDE",
            input_schema={"pde_kind": "str", "grid_shape": "tuple"},
            output_schema={"solution": "Tensor"},
            module_path="pinneaple_solvers",
            fn=self._safe_wrap(_run_fdm_solver, "pinneaple_solvers"),
            tags=["fdm", "solver", "classical"],
        ))

        def _run_sph(n_particles: int = 1000, **kwargs: Any) -> Any:
            try:
                from pinneaple_simulation.particle_dynamics import SPHParticles, ParticleSystem  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            category="simulation",
            description="Particle-based fluid simulation via pinneaple_dynamics SPH",
            input_schema={"n_particles": "int"},
            output_schema={"particle_states": "List[Tensor]"},
            module_path="pinneaple_dynamics",
            fn=self._safe_wrap(_run_sph, "pinneaple_dynamics"),
    ...
    def _register_pde_tools(self) -> None:
        def _compile_pinn(pde_kind: str, domain: Any, **kwargs: Any) -> Any:
            from pinneaple_physics.pinn_solver import compile_problem  # type: ignore
            return compile_problem(pde_kind=pde_kind, domain=domain, **kwargs)

        self.register(PhysicsTool(
            name="compile_pinn",
            category="pde_solving",
            description="Compile a PINN problem via pinneaple_pinn",
            input_schema={"pde_kind": "str", "domain": "PhysicsDomain"},
            output_schema={"pinn_problem": "CompiledProblem"},
            module_path="pinneaple_pinn",
            fn=self._safe_wrap(_compile_pinn, "pinneaple_pinn"),
            tags=["pinn", "pde", "compile"],
        ))

        def _identify_pde(description: str, **kwargs: Any) -> Any:
            from pinneaple_physics.pde_environment.capabilities import identify_pde  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_environment.capabilities",
            fn=self._safe_wrap(_identify_pde, "pinneaple_environment"),
            tags=["pde", "auto", "discovery"],
        ))

        def _suggest_problem_spec(description: str, **kwargs: Any) -> Any:
            from pinneaple_physics.pde_environment.capabilities import suggest_problem_spec  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_environment.capabilities",
            fn=self._safe_wrap(_suggest_problem_spec, "pinneaple_environment"),
    ...
    def _register_data_tools(self) -> None:
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_worldmodel.dataset",
            fn=_build_dataset,
        ...
        self.register(PhysicsTool(
            ...
            category="data_generation",
            description="Sample collocation points on a domain via pinneaple_data",
            input_schema={"domain": "PhysicsDomain", "n_points": "int"},
            output_schema={"points": "Tensor(N, d)"},
            module_path="pinneaple_data",
            fn=self._safe_wrap(_sample_collocation, "pinneaple_data"),
            tags=["collocation", "sampling"],
        ))

        def _active_learn(model: Any, domain: Any, **kwargs: Any) -> Any:
            from pinneaple_data import ResidualBasedAL, AdaptiveCollocationTrainer  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_data",
            fn=self._safe_wrap(_active_learn, "pinneaple_data"),
    ...
    def _register_training_tools(self) -> None:
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_worldmodel.trainer",
        ...
        def _train_pinn(problem: Any, model: Any = None, **kwargs: Any) -> Any:
            try:
                from pinneaple_neural.trainer import Trainer, TrainConfig  # type: ignore
        ...
        self.register(PhysicsTool(
            name="train_pinn",
            category="training",
            description="Train a PINN model via pinneaple_train",
            input_schema={"problem": "CompiledProblem", "model": "nn.Module"},
            output_schema={"model": "nn.Module", "history": "List[dict]"},
            module_path="pinneaple_train",
            fn=self._safe_wrap(_train_pinn, "pinneaple_train"),
            tags=["pinn", "training"],
        ))
    ...
    def _register_validation_tools(self) -> None:
        def _validate_physics(model: Any, dataset: Any, scenario: str = "", **kwargs: Any) -> Any:
            try:
                from pinneaple_analysis.validation import PhysicsValidator  # type: ignore
                pv = PhysicsValidator()
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_validate",
            fn=self._safe_wrap(_validate_physics, "pinneaple_validate"),
    ...
    def _register_uq_tools(self) -> None:
        def _mc_dropout_uq(model: Any, x: Any, n_samples: int = 50, **kwargs: Any) -> Any:
            from pinneaple_analysis.uncertainty import uq_predict  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_uq",
            fn=self._safe_wrap(_mc_dropout_uq, "pinneaple_uq"),
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_uq",
            fn=self._safe_wrap(_aleatoric_uq, "pinneaple_uq"),
            tags=["uq", "aleatoric", "heteroscedastic"],
        ))

        def _decompose_uq(model: Any, x: Any, n_samples: int = 50, **kwargs: Any) -> Any:
            from pinneaple_analysis.uncertainty import decompose_uncertainty  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            output_schema={"aleatoric_std": "Tensor", "epistemic_std": "Tensor",
                           "total_std": "Tensor"},
            module_path="pinneaple_uq",
            fn=self._safe_wrap(_decompose_uq, "pinneaple_uq"),
    ...
    def _register_inverse_tools(self) -> None:
        def _eki_inversion(model: Any, observations: Any, prior: Any = None, **kwargs: Any) -> Any:
            from pinneaple_analysis.inverse_problems import EnsembleKalmanInversion  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_inverse",
            fn=self._safe_wrap(_eki_inversion, "pinneaple_inverse"),
            tags=["inverse", "eki", "parameter"],
        ))

        def _sindy(trajectory: Any, **kwargs: Any) -> Any:
            from pinneaple_analysis.inverse_problems import SINDyIdentifier  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_inverse",
            fn=self._safe_wrap(_sindy, "pinneaple_inverse"),
            tags=["inverse", "sindy", "discovery", "sparse"],
        ))

        def _sensitivity(model: Any, params: Any, **kwargs: Any) -> Any:
            from pinneaple_analysis.inverse_problems import LocalSensitivity  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_inverse",
            fn=self._safe_wrap(_sensitivity, "pinneaple_inverse"),
    ...
    def _register_transfer_tools(self) -> None:
        def _transfer_train(source_model: Any, target_dataset: Any, **kwargs: Any) -> Any:
            from pinneaple_adaptation.transfer_learning import TransferTrainer  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            output_schema={"model": "nn.Module", "history": "List[dict]"},
            module_path="pinneaple_transfer",
            fn=self._safe_wrap(_transfer_train, "pinneaple_transfer"),
            tags=["transfer", "fine-tuning", "adaptation"],
        ))

        def _parametric_transfer(model: Any, family: Any, **kwargs: Any) -> Any:
            from pinneaple_adaptation.transfer_learning import ParametricFamilyTransfer  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_transfer",
            fn=self._safe_wrap(_parametric_transfer, "pinneaple_transfer"),
    ...
    def _register_meta_tools(self) -> None:
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_worldmodel.meta_learning",
            fn=_reptile,
    ...
    def _register_timeseries_tools(self) -> None:
        def _ts_forecast(data: Any, horizon: int = 10, **kwargs: Any) -> Any:
            from pinneaple_systems.time_series import LSTMForecaster, TimeSeriesSpec  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            category="timeseries",
            description="Time-series forecasting via pinneaple_timeseries (LSTM/NBeats/TFT)",
            input_schema={"data": "Tensor", "horizon": "int"},
            output_schema={"forecast": "Tensor", "uncertainty": "Tensor"},
            module_path="pinneaple_timeseries",
            fn=self._safe_wrap(_ts_forecast, "pinneaple_timeseries"),
            tags=["timeseries", "forecast", "lstm"],
        ))

        def _power_spectrum(data: Any, **kwargs: Any) -> Any:
            from pinneaple_systems.time_series import power_spectrum  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_timeseries",
            fn=self._safe_wrap(_power_spectrum, "pinneaple_timeseries"),
    ...
    def _register_cosim_tools(self) -> None:
        def _build_cosim(nodes: list, edges: list, **kwargs: Any) -> Any:
            from pinneaple_systems.cosimulation import CoSimGraph, CoSimEngine  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_cosim",
            fn=self._safe_wrap(_build_cosim, "pinneaple_cosim"),
            tags=["cosim", "multi-physics", "graph"],
        ))

        def _run_cosim(engine: Any, t_span: tuple = (0.0, 1.0), **kwargs: Any) -> Any:
            from pinneaple_systems.cosimulation import TrajectoryRecorder  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_cosim",
            fn=self._safe_wrap(_run_cosim, "pinneaple_cosim"),
    ...
    def _register_geometry_tools(self) -> None:
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_worldmodel.geometry",
            fn=_make_domain,
        ...
        def _make_sdf(shape: str = "circle", **kwargs: Any) -> Any:
            try:
                from pinneaple_design.geometry import sdf2d_circle, SDF  # type: ignore
                if shape == "circle":
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_geom",
            fn=self._safe_wrap(_make_sdf, "pinneaple_geom"),
    ...
    def _register_inference_tools(self) -> None:
        def _infer_2d(model: Any, x: Any, y: Any, **kwargs: Any) -> Any:
            from pinneaple_neural.predictor import infer_on_grid_2d  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_inference",
            fn=self._safe_wrap(_infer_2d, "pinneaple_inference"),
            tags=["inference", "grid", "2d"],
        ))

        def _plot_field(field: Any, **kwargs: Any) -> Any:
            from pinneaple_neural.predictor import plot_field_2d  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_inference",
            fn=self._safe_wrap(_plot_field, "pinneaple_inference"),
            tags=["viz", "field", "2d"],
        ))
    ...
    def _register_design_opt_tools(self) -> None:
        def _bayesian_opt(objective: Any, bounds: Any, **kwargs: Any) -> Any:
            from pinneaple_design.design_optimizer import BayesianDesignOptimizer  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_design_opt",
            fn=self._safe_wrap(_bayesian_opt, "pinneaple_design_opt"),
    ...
    def _register_digital_twin_tools(self) -> None:
        def _build_twin(model: Any, stream: Any, **kwargs: Any) -> Any:
            from pinneaple_systems.digital_twin import DigitalTwin  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_digital_twin",
            fn=self._safe_wrap(_build_twin, "pinneaple_digital_twin"),
            tags=["digital_twin", "real-time", "assimilation"],
        ))

        def _ekf(model: Any, obs: Any, **kwargs: Any) -> Any:
            from pinneaple_systems.digital_twin import ExtendedKalmanFilter  # type: ignore
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_digital_twin",
            fn=self._safe_wrap(_ekf, "pinneaple_digital_twin"),
    ...
    def _register_worldmodel_tools(self) -> None:
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_worldmodel.mega_model",
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_worldmodel.model",
            fn=_rollout,
        ...
        self.register(PhysicsTool(
            ...
            module_path="pinneaple_worldmodel.benchmark",
            fn=_benchmark,
