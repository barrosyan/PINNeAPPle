...
* **Sampling**: ``interior_points``, ``boundary_points`` integrate with
  ``pinneaple_data.CollocationSampler`` when available
...
Quick start::
    ...
    from pinneaple_worldmodel.geometry import Rectangle, Circle, Difference
...
class PhysicsDomain:
    ...
    def to_collocation_dict(
        ...
        *,
        ...
        """Return a dict compatible with ``pinneaple_data.CollocationSampler``.
