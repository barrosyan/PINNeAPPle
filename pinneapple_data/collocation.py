...
- SDF-defined domains (from pinneapple_geom)
...
class CollocationSampler:
    ...
    All outputs are in the standard pinneapple batch dict format.
    ...
    def from_problem_spec(
        ...
        """Create from a pinneapple_environment ProblemSpec."""
        ...
        for cond in spec.conditions:
            ...
            if sel_type == "tag" and isinstance(sel, dict):
                ...
                from pinneapple_simulation.numerical_solvers.problem_runner import _sample_callable_condition, _make_ctx
    ...
    def from_domain(
        ...
        """Create from a pinneapple_geom PhysicsDomain2D."""
    ...
    def from_mesh(
        ...
        """Create from a pinneapple_geom Mesh2D."""
        v = mesh.vertices
    ...
    def from_stl(
        ...
        """Create from an STL file using pinneapple_geom.sample surface samplers."""
        try:
            from pinneapple_design.geometry.sample import sample_surface_points
            from pinneapple_data.stl_import import load_stl
        except ImportError as e:
            raise ImportError(f"from_stl requires pinneapple_geom and pinneapple_data.stl_import: {e}")
    ...
    def _interior_points(self, n: int, rng: np.random.Generator) -> np.ndarray:
        """Sample n interior points; delegates to pinneapple_geom.sample when available."""
