...
#  - UPDItem (from pinneapple_pinn.io) with .open_dataset() / .load_meta()
UPDInput = Union[
    Tuple[str, str],
    Dict[str, Any],
    Any,
...
def upd_to_physical_sample(
    ...
    *,
    ...
    Requires `pinneapple_data.physical_sample.PhysicalSample` to exist.
    ...
    try:
        ...
        raise ImportError(
            "PhysicalSample not found. Create pinneapple_data/physical_sample.py with PhysicalSample dataclass."
        ) from e
