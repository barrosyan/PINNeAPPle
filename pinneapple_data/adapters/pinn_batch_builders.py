...
Expected output format (consumed by pinneapple_pinn.compiler):
...
def build_from_bundle(
    ...
    *,
    ...
    ----------
    bundle:
        ``pinneapple_arena.bundle.loader.BundleData`` instance (typed as Any to
        avoid a hard dependency on pinneapple_arena).
    """
