"""pinneapple_quantum — PINNeAPPle Quantum Module (PQM).
...
Quick start
-----------
>>> import pinneapple_quantum as pqm
...
# ── Training ──────────────────────────────────────────────────────────────────
from pinneapple_quantum.training.trainer import (
    QTrainer,
    QTrainerConfig,
    QTrainHistory,
...
# ── Pipeline presets ──────────────────────────────────────────────────────────
from pinneapple_quantum.pipeline.presets import (
    vq_pinn,
    hybrid_pinn,
    learn_hamiltonian,
    quantum_kernel,
...
from pinneapple_quantum import loss, training, data, pipeline, backends, circuits, models
