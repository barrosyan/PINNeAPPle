...
```bash
python examples/pinneapple_solvers/01_solvers_fft_feature_train.py
...
For serious FEM/FVM workloads, replace the scaffold assembly/topology with your pinneapple_geom mesh and higher-fidelity operators.