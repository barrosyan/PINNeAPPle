...
the pinneapple_design.geometry CSG module.  Each domain is sampled for interior
collocation points and boundary points, then visualised with matplotlib.

Run::

    python examples/pinneapple_design.geometry/07_csg_domain_demo.py

Output images are written to examples/pinneapple_design.geometry/_out/.
"""
