...
|---|---|---|
| Reptile meta-learning | ✅ `pinneapple_meta.ReptileTrainer` | ❌ |
| MAML meta-learning | ✅ `pinneapple_meta.MAMLTrainer` | ❌ |
| PDETaskSampler (amostragem de tarefas) | ✅ `pinneapple_meta.PDETaskSampler` | ❌ |
| TransferTrainer (fine-tuning parcial) | ✅ `pinneapple_transfer.TransferTrainer` | ❌ |
| ParametricFamilyTransfer | ✅ `pinneapple_transfer.ParametricFamilyTransfer` | ❌ |
| freeze / unfreeze layers | ✅ `pinneapple_transfer.freeze_layers` | ❌ |
| layer_lr_groups (LR discriminativo) | ✅ `pinneapple_transfer.layer_lr_groups` | ❌ |
...
```bash
cd examples/vs_physicsnemo/02_pinneapple_meta_transfer
python example.py
```
