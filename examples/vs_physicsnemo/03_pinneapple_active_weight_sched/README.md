...
|---|---|---|
| Residual-based Adaptive Collocation (RAD) | ✅ `pinneapple_data.ResidualBasedAL` | ❌ |
| Residual-based Adaptive Refinement (RAR) | ✅ `pinneapple_data.ResidualBasedAL` | ❌ |
| Variance-based Active Learning | ✅ `pinneapple_data.VarianceBasedAL` | ❌ |
...
```bash
cd examples/vs_physicsnemo/03_pinneapple_active_weight_sched
python example.py
```
