"""pinneaple_simulation — Physics simulation back-ends and data generation.

Sub-modules
-----------
numerical_solvers  (was pinneaple_solvers)
...
particle_dynamics  (was pinneaple_dynamics)
...
external_solvers   (was pinneaple_integrations)
...
Usage
-----
>>> from pinneaple_simulation import simulate, generate_data, HeatConduction3D
