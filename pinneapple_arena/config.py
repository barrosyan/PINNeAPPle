...
problem:
  name: kovasznay_ns
  physics_preset: ns_incompressible_2d_default   # optional: use pinneapple_physics preset
  params:
    re: 40.0
  grid_n: 40
  n_col: 2000
...
# Optional: load a pinneapple_data dataset instead of a built-in problem
# dataset:
...
class ProblemConfig:
    ...
    physics_preset: Optional[str]     = None    # override with pinneapple_physics preset name
...
@dataclass
class DatasetConfig:
    """Use a pinneapple_data dataset instead of a built-in Arena problem."""
    dataset_id: str           = ""
