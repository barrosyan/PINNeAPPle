"""pinneaple_adaptation — Transfer learning and meta-learning for PINNs.

Sub-modules
-----------
transfer_learning  (was pinneaple_transfer)
...
meta_learning      (was pinneaple_meta)
...
Usage
-----
>>> from pinneaple_adaptation import fine_tune, meta_train, fast_adapt
