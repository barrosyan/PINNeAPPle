...
try:
    ...
    from pinneaple_solvers.wavelet import WaveletSolver, wavedec_features
    from pinneaple_solvers.hilbert_huang import HilbertHuangSolver
    from pinneaple_solvers.eemd import EEMDSolver
    from pinneaple_solvers.ceemdan import CEEMDANSolver
    from pinneaple_solvers.vmd import VMDSolver
    from pinneaple_solvers.ssa import SSASolver
    from pinneaple_solvers.sst import SSTSolver
    from pinneaple_solvers.stl import STLSolver
    _CLASSICAL = [
