...
from pinneapple_tools.benchmark_suite.runner.metrics import ensure_float_dict
from pinneapple_tools.benchmark_suite.runner.report import write_run_artifacts
from pinneapple_tools.benchmark_suite.runner.leaderboard import update_leaderboard
from pinneapple_tools.benchmark_suite.registry import get_backend, get_task

# garante registro via decorators
from pinneapple_tools.benchmark_suite import tasks as _tasks  # noqa: F401
from pinneapple_tools.benchmark_suite import backends as _backends  # noqa: F401
...
def run_benchmark(
    *,
    ...
    backend_name = str(run_cfg.get("backend", {}).get("name", "pinneapple_native"))
