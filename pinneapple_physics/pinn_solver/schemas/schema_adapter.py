...
from pinneapple_physics.pinn_solver.factory import PINNProblemSpec
from pinneapple_physics.pinn_solver.io import ConditionSpec, SamplingSpec, PINNMapping
...
class SchemaAdapter:
    """
    Converts a Physical Schema (UPD/Pinneapple) into:
