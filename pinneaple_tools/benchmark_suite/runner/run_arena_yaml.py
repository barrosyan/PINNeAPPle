...
def _build_dataset(
    ...
    if data_source == "bundle":
        ...
        from pinneaple_tools.benchmark_suite.pipeline.dataset_builder import build_from_bundle
        ...
        from pinneaple_tools.benchmark_suite.pipeline.dataset_builder import build_from_real_data
