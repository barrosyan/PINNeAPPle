...
Quick start
-----------
from pinneaple_tools.visualization import use_cfd_style, plot_scalar, plot_vectors, plot_streamlines
from pinneaple_tools.visualization import plot_loss_history, plot_collocation, plot_pinn_prediction
from pinneaple_tools.visualization import animate_scalar_field, plot_solver_output
