...
def _run_solver(
    ...
    try:
        import pinneapple_simulation.numerical_solvers as _sol
    ...
    try:
        ...
        if cls_name == "HeatConduction3D":
            from pinneapple_simulation.numerical_solvers import HeatConfig3D, HeatConduction3D
            ...
            from pinneapple_simulation.numerical_solvers import NavierStokesConfig3D, NavierStokes3D
            nx = cfg.grid_resolution
            b = list(bounds.values())
            ...
            from pinneapple_simulation.numerical_solvers import LidDrivenCavityConfig3D, LidDrivenCavitySolver3D
