...
class FFTNNForecaster:
    ...
    Usage::
        from pinneaple_systems.time_series.decomposition import FFTNNForecaster
        from pinneaple_systems.time_series.models import LSTMForecaster, RecurrentConfig
