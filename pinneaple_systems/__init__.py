"""pinneaple_systems — Multi-component physical systems (time series, co-simulation, digital twins).

Sub-modules
-----------
time_series    (was pinneaple_timeseries)
...
cosimulation   (was pinneaple_cosim)
...
digital_twin   (pinneaple_digital_twin — same name, clearer context)
...
Usage
-----
>>> from pinneaple_systems import build_digital_twin, cosim_from_models, forecast
