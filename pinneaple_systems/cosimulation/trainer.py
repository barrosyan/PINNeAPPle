...
Usage::
    ...
    from pinneaple_systems.cosimulation import CoSimGraph, CoSimEngine, CoSimLoss
    from pinneaple_systems.cosimulation.trainer import CoSimTrainer
...
class CoSimTrainer:
    ...
    def _build_weight_scheduler(self, params: List) -> Optional[Any]:
        if self._ws_cfg is None:
            return None
        try:
            from pinneaple_neural.trainer.weight_scheduler import WeightScheduler
            import torch.nn as nn
