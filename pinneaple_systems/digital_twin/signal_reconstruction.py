...
Usage
-----
>>> from pinneaple_systems.digital_twin import DigitalTwin
>>> from pinneaple_systems.digital_twin.signal_reconstruction import SignalReconstructor
...
def reconstruct_ssa(
    ...
    *,
    ...
    Uses pinneaple_simulation.numerical_solvers.ssa.ssa_decompose internally.
    """
    from pinneaple_simulation.numerical_solvers.ssa import ssa_decompose
...
def reconstruct_wavelet(
    ...
    *,
    ...
    Uses pywt via pinneaple_simulation wavelet helper.
    """
    try:
        import pywt
    except ImportError:
