...
ParamSpace, OptState: re-exported from pinneapple_design_opt.optimizer (canonical location).
...
# Re-export canonical types from pinneapple_design_opt
from pinneapple_design.design_optimizer.optimizer import (  # noqa: F401
    ParamSpace,
    OptState,
