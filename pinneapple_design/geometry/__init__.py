# pinneapple_geom/__init__.py

"""
pinneapple_geom

Geometry + mesh utilities for Pinneapple.
...
Design principles:
- Keep `pinneapple_geom` independent from `pinneapple_pdb` (ETL) and `pinneapple_pinn` (loss/models)
...
"""Public API for `pinneapple_geom`.
