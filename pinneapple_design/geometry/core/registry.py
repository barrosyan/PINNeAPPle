...
def build_geometry_asset(
    ...
    *,
    ...
    Supported kinds:
      ...
      - primitive  (delegated to pinneapple_geom.gen.primitives)
    ...
    if kind in ("file", "mesh_file"):
        ...
        try:
            from pinneapple_design.geometry.gen.primitives import build_primitive  # type: ignore
        except Exception as e:
            raise ImportError("Primitive generation requires pinneapple_geom.gen.primitives") from e
