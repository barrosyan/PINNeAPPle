...
from pinneapple_design.geometry.io.meshio_bridge import _require_meshio, load_meshio
...
def sdf2d_to_tri_mesh(
    ...
    *,
    ...
    try:
        gmsh.model.add("pinneapple_sdf2d")
        ...
        out_msh = cache_path or "/tmp/pinneapple_sdf2d.msh"
        gmsh.write(out_msh)
    finally:
        gmsh.finalize()
