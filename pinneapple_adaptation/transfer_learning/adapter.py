...
class PhysicsTransferAdapter:
    ...
    def adapt_physics_loss(
        ...
        The returned callable has the standard pinneapple loss signature::
        ...
        callable
            ...
            :class:`~pinneapple_train.trainer.Trainer` or
            :class:`~pinneapple_transfer.trainer.TransferTrainer`.
        """
