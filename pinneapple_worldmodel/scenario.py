...
Pinneapple solver to use.  The :data:`BUILTIN_SCENARIOS` registry provides
ready-made scenarios covering common PDE families.

Quick start::

    from pinneapple_worldmodel import PhysicsScenario, BUILTIN_SCENARIOS
...
class PhysicsScenario:
    ...
    solver : str
        Which Pinneapple solver to use: ``"fdm"``, ``"lbm"``, ``"fem"``,
