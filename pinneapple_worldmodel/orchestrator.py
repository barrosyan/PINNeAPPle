...
Pinneapple capability as a callable tool and chains them intelligently to
...
Quick start::
    ...
    from pinneapple_worldmodel.orchestrator import PhysicsOrchestrator, ProblemStatement
...
class PhysicsOrchestrator:
    """Solve arbitrary physics problems by chaining Pinneapple tools.
    ...
    def _plan_forecast(
        ...
        """Time-series forecasting via pinneapple_timeseries."""
        p = problem
        data = p.observations
        if data is None:
