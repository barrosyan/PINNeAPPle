...
---------
    ...
    python -m pinneapple_worldmodel.generate_datasets
    ...
    python -m pinneapple_worldmodel.generate_datasets --smoke-test
...
def _generate_pinn_source(
    ...
    try:
        ...
        from pinneapple_neural.predictor import batched_inference
    except ImportError as exc:
        log.warning("PINN source requires pinneapple_physics + pinneapple_neural: %s", exc)
