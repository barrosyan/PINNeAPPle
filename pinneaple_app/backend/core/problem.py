"""Problem definition layer for pinneaple_app.

Two paths:
- Preset  : load from pinneaple_environment registry by name
...
class ProblemDefinition:
    """Unified problem container used throughout pinneaple_app."""
    kind: str                          # "preset" | "custom"
    name: str                          # display name
    spec: Any                          # pinneaple_environment.ProblemSpec
...
def load_preset(preset_name: str) -> ProblemDefinition:
    ...
    from pinneaple_physics.pde_environment import identify_pde
