...
pinneaple_train and pinneaple_data.  pinneaple_train.normalizers and
pinneaple_train.preprocess both re-export from here.
"""
...
class Normalizer:
    ...
    # ── aliases used by pinneaple_train.preprocess (encode/decode API) ──────
...
class StandardScaler(Normalizer):
    ...
    Supports two construction styles:
      ...
      - ``StandardScaler().fit(x)``        ← instance style (pinneaple_train)
    ...
    # ── instance fit (pinneaple_train.normalizers style) ────────────────────
    ...
    # ── serialization (pinneaple_train.preprocess style) ────────────────────
