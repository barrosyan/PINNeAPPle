"""pinneapple_analysis — Model analysis, validation, and inversion.

Sub-modules
-----------
uncertainty     (was pinneapple_uq)
...
validation      (was pinneapple_validate)
...
inverse_problems  (was pinneapple_inverse)
...
Usage
-----
>>> from pinneapple_analysis import validate_model, uq_predict, InverseProblemSolver
