"""pinneaple_design — Geometry construction and physics-guided design optimization.

Sub-modules
-----------
geometry         (was pinneaple_geom)
...
design_optimizer  (was pinneaple_design_opt)
...
Usage
-----
>>> from pinneaple_design import build_domain, sample_domain, optimize
